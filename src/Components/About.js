        ...
        <div name='about' className='w-full bg-gradient-to-b from-gray-800 to-black h-screen pt-[600px] mb-20 sm:pt-0'>
            <div className="flex flex-col justify-center max-w-screen-lg  p-4 w-full h-full mx-auto">
                ...
                <p className='text-gray-400 text-xl leading-8'>
                    Greetings! I'm Aryan Pandey, an enthusiastic web developer specializing in the MERN stack. My passion for technology fuels my continuous quest for learning. Currently pursuing a B.Tech in Computer Science and Engineering at Shri Ram Swaroop Memorial college of engineering and Management Lucknow, I find immense joy in the dynamic world of frontend development.
                    <br />
                    <br />
